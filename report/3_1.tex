...
$50Hz$ to $5kHz$ with a sampling frequency of $5kHz$ an brickwall filter at
$2.5kHz$.
...
$50Hz$ to $25\% \cdot 5kHz$ with a sampling frequency of $5kHz$.
Each color represents the frequency response at a
...
$50Hz$ to $25\% \cdot 5kHz$ with a sampling frequency of $5kHz$ run through a
zero-order hold DAC.
Each color represents the frequency response at a
